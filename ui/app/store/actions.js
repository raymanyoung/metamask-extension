...
function updateAndSetCustomRpc (newRpc, chainId, ticker = 'GAS', nickname, rpcPrefs) {
  return (dispatch) => {
...
function editRpc (oldRpc, newRpc, chainId, ticker = 'GAS', nickname, rpcPrefs) {
  return (dispatch) => {
...
function setRpcTarget (newRpc, chainId, ticker = 'GAS', nickname) {
  return (dispatch) => {
